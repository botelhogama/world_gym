...
start_time = time()
members_data_itapoa = get_data.GetClientData(endpoint="/api/v1/members", take_number=25, unidade="itapoa")
df_members_itapoa = members_data_itapoa.retrieve_data(use_cache=True)
print(f"df_members_itapoa shape is : {df_members_itapoa.shape}")
